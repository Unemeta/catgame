...
const DialogLetter = ({ show, setShow, cb }: iDialogExchange) => {
      ...
      <DialogContent className="p-0 h-auto w-[83vw]">
        ...
        <div className="bg-[url('/img/bg/bg_letter_dialog.png')] h-[48rem] bg-100100 p-[2.5rem] relative  rounded-[3rem]  shadow-[0px_4px_20px_0px_rgba(0,0,0,0.55)] border-[#FFFFF7] border-[0.2rem]">
          <div className=" inline-flex flex-col justify-start items-center overflow-hidden w-full">
            <div className="text-[#E96959] text-[1.8rem] font-[800] mb-[1.6rem]">Countdown X days</div>
            <div className="text-[#826662] text-[1.4rem] font-[500]">
              ...
              interaction with you every day✍ <br />1.🕰 If you persist for x days,
              you will receive a "Cat Thoughts Summary Letter" that belongs only
              to you, and there are hidden Easter eggs waiting for you to
              discover. <br />2. 🎀 If you want to know more cats, come to the
              community and leave your footprints. Exclusive identity,
              mysterious rewards, and super cute emojis are waiting for you to
              take away! <br />3. Join the <span className="text-[#E96959] font-[700]">discord</span> community and complete the
              questionnaire, then you will have a chance to get a mysterious
              reward
            </div>
          </div>
