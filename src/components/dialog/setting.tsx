  ...
  return (
    ...
    >
      ...
      <DialogContent className="p-0 h-auto w-[83vw]">
        ...
        <div
          className="rounded-[3rem] bg-[linear-gradient(187deg,#B48471_-9.74%,rgba(212,204,195,0.8)_100%)] shadow-[0px_4px_20px_0px_rgba(0,0,0,0.55)] border-[#FFFFF7] border-[0.2rem] "
          // style={{
          //   background:
          ...
          <div className="px-[2rem]">
            ...
            <div className="flex justify-center items-center mt-[1rem]">
              <div
                ...
                onClick={() => {
                  localStorage.setItem("tabn","tabnout");
