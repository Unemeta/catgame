        ...
        <div className={styles.backpackBg}>
          ...
          <div className="flex flex-col chatCttH">
            <div className="flex justify-end items-start dmb40 grow overflow-y-scroll">
              <div className="chatCtt grid grid-cols-1 dgap20 overflow-y-scroll dpr36">
                      ...
                      >
                        ...
                        <div className="dmaxW460 lmd:max-w-[400px]">
                          ...
                          <div className="dtext28 font-[500] text-[#F5F2FF]">
                            At least 34 people have been killed and 117 injured
                            in a Russian attack on the city of Sumy, according
